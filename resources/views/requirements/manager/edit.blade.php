...
@section('content')
    <x-form_elements.index>
        ...
        <x-form_elements.form action="{{route('manager.requirements.update', $requirement->id)}} " enctype="multipart/form-data">
            <div class="mb-6">
                <x-form_elements.universal name="title" type="text">Název</x-form_elements.universal>
            </div>
            ...
            <div class="flex items-center justify-center">
                <a href="{{route('manager.requirements.show', $requirement->id)}}" class="bg-yellow-500 text-center text-white  hover:bg-red-600 px-5 py-2.5 rounded-lg font-bold w-auto flex items-center justify-center m-3">
                    Zrušit
                </a>
